...
LEDstrip::LEDstrip(int n)
  ...
  void LEDstrip::setNumLEDS(int n){
    numberLEDs = n;
  }

  void LEDstrip::setLEDPattern(int p){
    kPattern = p;
  }
  int LEDstrip::getLEDPattern(){
    return kPattern;
  }
  void LEDstrip::setColor1(int c){
    kColor1 = c;
  }  
  int LEDstrip::getColor1(){
    return kColor1;
  }
  void LEDstrip::setColor2(int c){
    kColor2 = c;
  }
  void LEDstrip::setFade(int f){
    kFade = f;
  }
  void LEDstrip::setLEDRate(int r){
    kRate = r;
  }

  void LEDstrip::ResetValues(){
    kPattern = 1;
    kColor1 = 192;
    kColor2 = 192;
    kFade = DEFAULT_FADE;
  ...
  void LEDstrip::Update(int counter, CRGB l[]){
    Update(counter, l, kPattern, kColor1, kColor2, kRate, kFade);
  }
  //counter is an increment 
  void LEDstrip::Update( int counter, CRGB l[], int pattern, int color1, int color2, int rate = DEFAULT_RATE, int fade = DEFAULT_FADE  )
  {
